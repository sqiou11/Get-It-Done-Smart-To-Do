module.exports = function(app, appEnv) {
  ...
  router.post('/start', function(req, res) {
  	...
  	db.none('CREATE TABLE IF NOT EXISTS applications.\"' + req.body['username'] + '\"' +
          ...
          machine: req.body['machine']
  			...
  			db.none('INSERT INTO applications.\"' + req.body['username'] + '\"(name, start_time, end_time, active, machine) VALUES (${name}, ${start_time}, NULL, TRUE, ${machine})', params)
  				.then(function(data) {
  					console.log(data);
  					res.send('success');
  				})
  ...
  router.post('/end', function(req, res) {
  	...
  	db.none('UPDATE applications.\"' + req.body['username'] + '\" SET end_time=${end_time}, active=FALSE WHERE name=${name} AND active=TRUE AND machine=${machine}', params)
  		.then(function() {
  			res.send('success');
  		})
  		.catch(function(error) {
  ...
  router.get('/', function(req, res) {
  	...
  	db.many('SELECT * FROM applications.\"' + req.query['username'] + '\" WHERE start_time>=${start_time} AND start_time<${end_time} ORDER BY machine', params)
  		.then(function(data) {
  			console.log(data);
  			res.send(data);
  		})
